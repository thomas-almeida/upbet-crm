...
const types = [
    {
        id: 1,
        label: "Dep. 24hrs pos campanha"
    },
    {
        id: 2,
        label: "Dep. 48h pos campanha"
    },
    {
        id: 3,
        label: "Dep. 7 dias pos campanha"
    }
]
...
async function getUsersImpact(campaignDataId, campaignId) {
    try {
        ...
        targetCampaign['Clientes impactados'] = depositsCount
        console.log(`${campaignDataId}:${campaignId} - Clientes Impactados atualizados ✅`)
        fs.writeFileSync(campaignDB, JSON.stringify(campaigns, null, 2))
...
async function getDepositsByRange(campaignDataId, campaignId, range) {
    ...
    try {
        ...
        fs.writeFileSync(campaignDB, JSON.stringify(campaigns, null, 2))
        console.log(`${campaignDataId}:${campaignId} - Depositos Atualizados ✅`)
