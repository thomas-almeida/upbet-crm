...
CSV_FILE_PATH = os.path.join(CSV_DIR, f'{CAMPAIGN_ID}_r_sms_clicked_f_campaignid_{TIMESTAMP}.csv')
...
WHERE
  a.audience_id = 1051628
  AND r.resource_type_id IN (3)
  AND c.fact_type_id IN (4)
ORDER BY 
  j.event_date DESC
LIMIT 100000
"""
